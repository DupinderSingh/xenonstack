...
var $wrapper = $(".wrapper");
let slider = document.getElementsByClassName("theme-6-active");
...
var droopy = function(){
	...
	var sidebarNavCollapse = $('.custom-sidebar-left.fixed-sidebar-left .side-nav  li .collapse');
	var sidebarNavAnchor = '.custom-sidebar-left.fixed-sidebar-left .side-nav  li a';
	...
	$(document).on('click', '#toggle_nav_btn', function (e) {
		$(".theme-6-active").toggleClass("slide-nav-toggle");
		// slider.toggleClass('slide-nav-toggle');
	...
	$(document).on('click', '#toggle_mobile_nav', function (e) {
		slider.toggleClass('mobile-nav-open').removeClass('open-right-sidebar');
		return;
	});
