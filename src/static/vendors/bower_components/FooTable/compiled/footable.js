...
(function($, F){
	...
	F.Editing = F.Component.extend(/** @lends FooTable.Editing */{
		/**
		 * The editing component adds a column with manage and delete buttons to each row as well as a single add row button in the footer.
		 * @constructs
		 * @extends FooTable.Component
		 * @param {FooTable.Table} table - The parent {@link FooTable.Table} object for the component.
		...
		construct: function(table){
			...
			/**
			 * The text that appears in the manage button. This can contain HTML.
			 * @type {string}
			 */
			...
			/**
			 * This object is used to contain the callbacks for the add, manage and delete row buttons.
			 * @type {object}
		...
		$create: function(){
			...
			self.ft.$el.addClass('footable-editing').addClass(position)
				...
				.on('click.ft.editing', '.footable-manage', {self: self}, self._onEditClick)
		...
		/**
		 * Creates the manage button for the editing component.
		 * @instance
		 * @protected
		 * @returns {(string|HTMLElement|jQuery)}
		 */
		$buttonEdit: function(){
			return '<button type="button" class="btn btn-default footable-manage">' + this.editText + '</button> ';
		},
		/**
		...
		/**
		 * Handles the manage button click event.
		 * @instance
		 * @private
		 * @param {jQuery.Event} e - The jQuery.Event object for the event.
		 * @fires FooTable.Editing#"manage.ft.editing"
		 */
		_onEditClick: function(e){
			...
			if (row instanceof F.Row){
				/**
				 * The manage.ft.editing event is raised before its callback is executed.
				 * Calling preventDefault on this event will prevent the callback from being executed.
				 * @event FooTable.Editing#"manage.ft.editing"
				 * @param {jQuery.Event} e - The jQuery.Event object for the event.
				 * @param {FooTable.Table} ft - The instance of the plugin raising the event.
...
(function($, F) {
	 ...
	 * @prop {function} editRow - The callback function to execute when the manage row button is clicked.
	 * @prop {function} deleteRow - The callback function to execute when the delete row button is clicked.
	 * @prop {string} showText - The text that appears in the show button. This can contain HTML.
	 * @prop {string} hideText - The text that appears in the hide button. This can contain HTML.
	 * @prop {string} addText - The text that appears in the add button. This can contain HTML.
	 * @prop {string} editText - The text that appears in the manage button. This can contain HTML.
